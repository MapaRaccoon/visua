...
LinearSpectrogram::LinearSpectrogram( std::string resourcesPath, boost::lockfree::spsc_queue<float> &rbuf )
    : rbuf( rbuf )
...
Command LinearSpectrogram::step()
{
