...
StarVisualizer::StarVisualizer( std::string resourcesPath, boost::lockfree::spsc_queue<float> &rbuf )
    : rbuf( rbuf )
    , params(
          { .wiggleOffset = 4.0,
            .wiggleAmplitude = 0.2,
...
void StarVisualizer::updateUniforms()
{
...
gfx::Program StarVisualizer::makeShaderProgram( std::string resourcesPath )
{
